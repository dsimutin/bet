...
class HomeAdvantageBuilder:
    ...
    def build(self, matches: pd.DataFrame, cutoff_date: date | None = None) -> HomeAdvantageBuilder:
        df = _prepare(matches)
    ...
    def features_for_match(self, home_team: str, away_team: str) -> HomeAdvantageFeatures:
