...
_ATP_LASTNAMES = {
    "djokovic", "alcaraz", "sinner", "medvedev", "zverev", "tsitsipas",
    "rublev", "ruud", "fritz", "de minaur", "deminaur", "hurkacz",
    "musetti", "dimitrov", "paul", "norrie", "korda", "tiafoe",
    "auger-aliassime", "schwartzman", "berrettini", "carreno", "busta",
    "wawrinka", "kyrgios", "khachanov", "cilic", "sonego", "krajinovic",
    "davidovich", "fokina", "nakashima", "brooksby", "mpetshi",
    "perricard", "shelton", "draper", "struff", "bublik", "safiullin",
    "kecmanovic", "tabilo", "cerundolo", "etcheverry", "arnaldi",
    "cobolli", "marozsan", "fils", "gasquet", "simon", "monfils",
    "thiem", "verdasco", "nishioka", "isner", "opelka", "giron",
    "wolf", "kokkinakis", "popyrin", "comesana", "navone",
}
...
def parse_tennis_tip(text: str, channel: str = "") -> TennisTip | None:
    ...
    tennis_keywords = ["tennis", "теннис", "atp", "wta", "roland", "wimbledon",
                       "grand slam", "открытый", "🎾"]
